...
- Fixed an issue where the EFI partition was not labeled correctly

## [0.2.3]

### Fixed

- Issue where system configuration did not contain a EFI partition on systems without disk encryption

## [0.2.2]

### Fixed

- Issue in `multiprocessing` module that caused the installation to fail
...
- Support new PantherX OS configuration format

## [0.1.8]

### Fixed

- Typo in disk formatting scripts `100s%` -> `100%`
